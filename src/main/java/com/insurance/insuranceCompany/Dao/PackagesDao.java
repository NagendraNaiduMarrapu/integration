...
public class PackagesDao {
	...
	public ArrayList<InsurancePackages> getAllPackages(){
		
		return (ArrayList<InsurancePackages>) jdbc.query("Select * from InsurancePackages ", new PackagesRowMapper());
	}


	public int addHospital(InsurancePackages insp) {
		...
		return jdbc.update(sql,insp.getInspTitle(),insp.getInspDesc(),insp.getInspStatus(),insp.getInspRangeStart(),insp.getInspRangeEnd(),insp.getInspAgeLimitStart(),insp.getInspAgeLimitEnd());
